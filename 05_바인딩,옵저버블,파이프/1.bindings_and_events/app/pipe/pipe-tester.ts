...
import {TemperaturePipe} from './template.pipe';

@Component ({
    selector : 'app',
    template : `
        <input type="text" value="0" placeholder="Enter temperature" [(ngModule)]="temp">
...
platformBrowserDynamic().bootstrapModule(AppModule)l